<div class="w-screen relative left-1/2 right-1/2 -mx-[50vw] bg-white py-12">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="self-stretch flex flex-col justify-center items-start gap-[25px] mb-8">
            <h2 class="self-stretch text-black text-[26px] font-bold font-marianne">Une opportunité massive, mais peu
                connue</h2>
            ...
            <div class="self-stretch flex flex-col justify-start items-start gap-[15px]">
                <p class="self-stretch text-black text-xl font-normal font-marianne leading-[30px]">
                    Aujourd'hui, <strong class="font-bold">90 % des foyers éligibles ne font pas valoir leurs
                        droits</strong>, par manque d'information ou par méconnaissance des démarches à suivre.
                    Pourtant, l'autoconsommation permet non seulement de <strong class="font-bold">réduire ses factures
                        jusqu'à 85 %</strong>, mais aussi de générer un revenu complémentaire en revendant l'électricité
                    excédentaire à EDF.
                </p>
                <p class="self-stretch text-black text-xl font-normal font-marianne leading-[30px]">
                    Si vous êtes propriétaire et que vous n'avez pas encore franchi le pas, <strong
                        class="font-bold">c'est le moment de s'informer.</strong>
                </p>
            </div>
        </div>

        <div
            class="self-stretch px-6 md:px-[110px] py-10 bg-[#013565]/5 rounded flex flex-col justify-start items-start gap-5">
            <p class="self-stretch text-black text-xl font-normal font-marianne">
                <strong class="font-bold">⚠️ Attention : ces aides sont limitées et attribuées selon l'ordre des
                    demandes.</strong>
                Il est possible de faire valoir son éligibilité dès maintenant afin de sécuriser son accès aux
                subventions, même si l'installation se fait plus tard.
            </p>

            <div
                class="h-[60px] px-[30px] py-2.5 bg-[#013565] rounded outline outline-1 outline-offset-[-1px] outline-[#013565] inline-flex justify-center items-center gap-3">
                ...
                <a href="{{ route('form') }}" class="text-right justify-start text-white text-lg font-bold font-marianne uppercase">vérifier
                    votre éligibilité</a>
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
